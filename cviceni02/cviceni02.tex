...
\end{minted}
        \item Proč? Když pak napíšeme \texttt{matice[3][0]}, tak program musí vědět, kolik sloupců má jeden řádky, aby se mohl posunout o správný počet buněk v \uv{jednorozměrném poli}.
    \end{itemizex}
\end{frame}
